...
# State - Completed values for each variable separately and average of all variables
Print_1 <-
...
# State - Completed values for Isolated start date where Isolated = Yes (Target=80%)
Print_2_template <-
  expand.grid(
    Year = Years,
    Quarter = c(1, 2, 3, 4)
...
# Regions - Completed values for each variable separately and average of all variables
Print_3_template <-
  expand.grid(
    Region = Regions,
    Year = Years,
...
# Regions - Completed values for Isolated start date
Print_4_template <-
  expand.grid(
    Region = Regions,
    Year = Years,
...
# State - Count and pct of total pass and fail on completing 80% or more data
Tabulate_5_template <-
    expand_grid(
    Year = Years,
    Quarter = c(1, 2, 3, 4),
...
# Regions - Count and pct of total pass and fail on completing 80% or more data
Tabulate_6_template <-
    expand_grid(
    Region = Regions,
    Year = Years,
...
# State - Percent of cases with control measure
  expand_grid(
    Year = Years,
...
# Regions - Percent of cases with control measure
Tabulate_8_template <-
  expand_grid(
    Region = Regions,
    Year = Years,
...
# State - Percent of cases with investigation started
Tabulate_9_template <-
  expand_grid(
    Year = Years,
    Quarter = as.character(c(1, 2, 3, 4))
...
# Regions - Percent of cases with investigation started
...
# State - Percent of cases approved and submitted to CDC
...
# Regions - Percent of cases approved and submitted to CDC
...
# Case classification evaluation - printing out reason rejected fields
Print_15 <-
  read_excel("Diphtheria quarterly output_Jan2022_Sep2024.xlsx",
...
[Percent of Cases with 80% or more data completed]{.underline}
...
[Percent of Cases with Control Measure Initiated within 1 business day]{.underline}
...
[Percent of cases with Investigation Started within 1 Business Day]{.underline}
...
[Percent of Cases Approved and Submitted to CDC within 30 days]{.underline}
...
[Percent of cases with correct case classification]{.underline}
